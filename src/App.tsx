            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="#lufs" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      LUFS Measurement
                    </a>
                  </li>
                  <li>
                    <a href="#platforms" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Platform Targets
                    </a>
                  </li>
                  <li>
                    <a href="#spectrogram" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Spectrogram View
                    </a>
                  </li>
                  <li>
                    <a href="#dynamics" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Dynamics Analysis
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/wiki" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      User Guide
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/CONTRIBUTING.md" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Contributing
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/issues" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Report Issues
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/releases" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Changelog
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="https://www.itu.int/rec/R-REC-BS.1770/en" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      ITU-R BS.1770-4
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/PRIVACY.md" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/LICENSE" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      MIT License
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/SECURITY.md" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Security
                    </a>
                  </li>
                </ul>
