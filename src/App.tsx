          ...
          <div className="py-8 sm:py-12">
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 lg:gap-12">
              ...
              <div className="col-span-1">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 leading-relaxed hidden sm:block">
                  Professional loudness analysis implementing EBU R 128 / ITU-R BS.1770-4 standards.
                </p>
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-3 leading-relaxed sm:hidden">
                  Audio loudness analyzer with EBU R 128 standards.
                </p>
              ...
              <div className="col-span-1">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a href="#waveform" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Waveform Analysis
                    </a>
                  </li>
                  <li>
                    <a href="#lufs" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      LUFS Measurement
                    </a>
                  </li>
                  <li>
                    <a href="#platforms" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Platform Targets
                    </a>
                  </li>
                  <li>
                    <a href="#spectrogram" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Spectrogram View
                    </a>
                  </li>
                  <li>
                    <a href="#dynamics" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Dynamics Analysis
                    </a>
                  </li>
                </ul>
              ...
              <div className="col-span-1">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/README.md" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Documentation
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/wiki" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      User Guide
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/CONTRIBUTING.md" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Contributing
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/issues" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Report Issues
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/releases" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Changelog
                    </a>
                  </li>
                </ul>
              ...
              <div className="col-span-1">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a href="https://tech.ebu.ch/docs/r/r128.pdf" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      EBU R 128
                    </a>
                  </li>
                  <li>
                    <a href="https://www.itu.int/rec/R-REC-BS.1770/en" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      ITU-R BS.1770-4
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/PRIVACY.md" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/LICENSE" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      MIT License
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/tillrd/Lufalyze/blob/main/SECURITY.md" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                      Security
                    </a>
                  </li>
                </ul>
